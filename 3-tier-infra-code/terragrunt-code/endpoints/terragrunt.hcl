terraform {
  source = "git::https://gitlab.idfy.com/code/infra/terraform-modules-aws.git//endpoints?ref=master_v2"
  #source = "D:/aws-terraform/aws-modules/terraform-modules-aws/endpoints"
}
